...
Version 3 (PV3)because of the following problem:
(1) Photcode is bound to the respective PV
...
def PV3download(filename, filetype):
    subprocess.call('wget ' + PV3url + filename + '.' + filetype + ' -O ' +
